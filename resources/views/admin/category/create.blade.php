                ...
                <div class="col-lg-6 offset-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('category#createCategoty') }}" method="post" novalidate="novalidate">
                                @csrf
                                <div class="form-group">
                                    <label for="cc-payment" class="control-label mb-1">Name</label>
                                    <input id="cc-pament" name="categoryName" value="{{ old('categoryName') }}" type="text" class="form-control @error('categoryName')
                                        is-invalid
                                    @enderror"
