                ...
                <div class="col-lg-10 offset-1">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin#updateAdminAccount', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-4 offset-1">
                                        ...
                                        @else
                                            <img src="{{ asset('storage/'.Auth::user()->image) }}" class="img-thubnail shadow-sm"/>
                                        @endif
                                    ...
                                    <div class="row col-6">
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="name" type="text"
                                                ...
                                                aria-required="true" aria-invalid="false" placeholder="Name..." value="{{ old('name', Auth::user()->name) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="email" type="text"
                                                ...
                                                aria-required="true" aria-invalid="false" placeholder="Email..." value="{{ old('email', Auth::user()->email) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="phone" type="number"
                                                ...
                                                aria-required="true" aria-invalid="false" placeholder="Phone..." value="{{ old('phone', Auth::user()->phone) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="role" type="text"
                                                ...
                                                aria-required="true" aria-invalid="false" disabled value="{{ old('role', Auth::user()->role) }}">
